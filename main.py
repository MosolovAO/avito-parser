...
# TODO: Научить парсер грамотно работать с базой данных
...
# TODO: Научить парсер грамотно работать с базой данных
# TODO: Научить парсер работать со списком геолокаций
# TODO: Научить парсер добавлять некоторые группы объявлений через день или через два дня
